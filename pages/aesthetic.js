...
export default function Random() {
  const imageList = [
    ...
    {
      src: "https://i.imgur.com/XS2YfDE.jpg",
      title: "geneva botanical garden",
    },
    {
      src: "https://i.imgur.com/cKf07vB.jpg[",
      title: "zermatt",
    },
    {
      src: "https://i.imgur.com/9zLrmUV.jpg",
      title: "gimmelwald",
    },
    { src: "https://i.imgur.com/AioMkDH.jpeg", title: "renoir painting" },
    { src: "https://i.imgur.com/sn0Wadb.jpeg", title: "oeschinen lake" },
    { src: "https://i.imgur.com/Q4Mgw6V.jpeg", title: "gornegrat" },
  ];
  ...
  return (
    <div class="columns-1 gap-5 md:columns-2 lg:columns-3 playfair-display">
      {imageList.map((image, index) => (
        <div
          key={index}
          className={`w-full p-3.5 group-hover:opacity-50 duration-300 ${
